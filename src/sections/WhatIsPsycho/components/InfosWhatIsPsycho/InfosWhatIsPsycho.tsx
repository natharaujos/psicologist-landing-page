...
function InfosWhatIsPsycho() {
  return (
    <Infos>
      ...
      <Paragraph color="black">
        A psicoterapia baseada em evidências (PBE) é um tipo de tratamento que
        utiliza métodos e abordagens com comprovação científica de eficácia.
        Isso significa que as técnicas usadas são testadas e validadas por
        pesquisas para garantir que realmente ajudam as pessoas. A Terapia
        Cognitivo-Comportamental (TCC) é um exemplo de psicoterapia baseada em
        evidências, focando em modificar padrões de pensamento negativos e
        comportamentos.
      </Paragraph>
      <Paragraph color="black">
        A TCC é considerada um "Padrão Ouro" de tratamento para diversas
        condições, como depressão, ansiedade e fobias, pois apresenta resultados
        consistentes em estudos clínicos. A PBE oferece um tratamento
        estruturado e focado, com estratégias claras para alcançar resultados.
        Seu foco em resultados mensuráveis e eficazes permite aos profissionais
        escolherem a abordagem mais adequada para cada pessoa. Esse tipo de
        psicoterapia é altamente respeitado por sua eficácia e base científica
        sólida.
      </Paragraph>
    </Infos>
  );
