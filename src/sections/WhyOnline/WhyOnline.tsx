...
function WhyOnline() {
  return (
    <section className="h-[30vh] 2xl:h-[30vh] xs:h-[400px] lg:h-[300px] w-full flex items-center bg-pink py-20">
      <div className="h-full flex flex-col justify-center items-center sm:px-8 sm:py-0 xs:px-5 text-center">
