...
function AboutMe() {
  return (
    <div id="aboutme" className="flex justify-center bg-creme gap-5">
      <section className="h-[100vh] xs:h-[1300px] md:h-[1000px] lg:h-[1000pxvh] 2xl:h-[900px] xl:h-[105vh] w-3/4 2xl:w-4/6 xs:w-full bg-pink flex items-center lg:rounded-2xl">
